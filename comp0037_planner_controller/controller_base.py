...
DRIVE_TO_GOAL_STATUS_SUMMARY_SAVEFILE = '/home/ros_user/datasave_assignment1/AstarByED_Factory_Summary_{}.txt'.format(timestr)
del timestr
...
class ControllerBase(ControllerRecord):
    ...
    def drivePathToGoal(self, path, goalOrientation, plannerDrawer):
        ...
        self.redirect_current_status_to_file(DRIVE_TO_GOAL_STATUS_SUMMARY_SAVEFILE, path, last_waypoint = str(waypoint))
