...
class AStarBySEDPlanner(GreedyRewiringPlanner): # or think about inherite from dijkstra if you feel like that is more natural
    ...
    def _costEvalFunc(self, fromCell, toCell):
        ...
        g = (self.computeLStageAdditiveCost(fromCell, connerCell))**2 + (self.computeLStageAdditiveCost(connerCell, toCell))**2
