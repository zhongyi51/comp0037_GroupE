...
class AStarPlanner_Squared_Euclidean(GreedyRewiringPlanner): # or think about inherite from dijkstra if you feel like that is more natural
	...
	L = (dX*dX+dY*dY)*cost# Multiplied by the terrain cost of the cell
