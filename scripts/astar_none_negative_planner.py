...
class AStarPlanner_None_Negative(GreedyRewiringPlanner): # or think about inherite from dijkstra if you feel like that is more natural
	...
	L = 1*cost# Multiplied by the terrain cost of the cell
